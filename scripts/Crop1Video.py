...
parser.add_argument("video_path", type=str, help="video_path - Path of the video to be cropped.")
parser.add_argument("video_filename", type=str, help="video_filename - Filename of the video to be cropped.")
...
print(f"Cropping the video {args.video_path}{args.video_filename} using coordinates: ({args.x1},{args.y1}) - ({args.x2},{args.y2})")
...
# Crop the video from the input arguments
